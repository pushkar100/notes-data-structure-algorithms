...
- [Intervals & Sweep Line](#intervals-sweep-line)
- [57. Insert Interval](#57-insert-interval)
    ...
    - [Note 1: Terminology Addendum](#note-1-terminology-addendum)
...
- [435. Non-overlapping Intervals](#435-non-overlapping-intervals)
    - [1. Problem Explanation](#1-problem-explanation)
    - [2. Solution Explanation](#2-solution-explanation)
      - [ASCII Diagram Walkthrough](#ascii-diagram-walkthrough)
    - [3. Time and Space Complexity Analysis](#3-time-and-space-complexity-analysis)
    - [4. Solution Code](#4-solution-code)
    - [Note 1: Terminology and Techniques](#note-1-terminology-and-techniques)
    - [Note 2: Real-World Interview Variations](#note-2-real-world-interview-variations)
...
- [Meeting rooms II](#meeting-rooms-ii)
    - [1. Problem Explanation](#1-problem-explanation)
    - [2. Solution Explanation](#2-solution-explanation)
      - [The Chronological Ordering Strategy](#the-chronological-ordering-strategy)
      - [Step-by-Step Visualization](#step-by-step-visualization)
    - [3. Time and Space Complexity Analysis](#3-time-and-space-complexity-analysis)
    - [4. Solution Code](#4-solution-code)
      - [Optimized Approach: Chronological Ordering (Two-Pointer)](#optimized-approach-chronological-ordering-two-pointer)
        - [Python](#python)
        - [JavaScript](#javascript)
...
- [1851. Minimum Interval to Include Each Query](#1851-minimum-interval-to-include-each-query)
    ...
    - [2. Solution Explanation](#2-solution-explanation)
      ...
      - [Phase 2: The Sweep Line](#phase-2-the-sweep-line)
    - [3. Time and Space Complexity Analysis](#3-time-and-space-complexity-analysis)
    - [4. Solution Code](#4-solution-code)
      - [Python Solution (Using )](#python-solution-using)
      - [JavaScript Solution (With Min-Heap Logic)](#javascript-solution-with-min-heap-logic)
    - [Note 1: Terminology and Techniques](#note-1-terminology-and-techniques)
    - [Note 2: Real-World / Interview Variations](#note-2-real-world-interview-variations)
...
- [452. Minimum Number of Arrows to Burst Balloons](#452-minimum-number-of-arrows-to-burst-balloons)
    - [1. Problem Explanation](#1-problem-explanation)
    - [2. Solution Explanation](#2-solution-explanation)
      - [The Strategy: Sort by End Point](#the-strategy-sort-by-end-point)
    - [3. Time and Space Complexity Analysis](#3-time-and-space-complexity-analysis)
    - [4. Solution Code](#4-solution-code)
...
- [Employee Free Time](#employee-free-time)
    - [1. Problem Explanation](#1-problem-explanation)
    - [2. Solution Explanation](#2-solution-explanation)
      - [Step 1: Flatten and Sort](#step-1-flatten-and-sort)
      - [Step 2: Merge Overlapping Intervals](#step-2-merge-overlapping-intervals)
    - [3. Time and Space Complexity Analysis](#3-time-and-space-complexity-analysis)
    - [4. Solution Code](#4-solution-code)
      - [Python Solution (Flatten & Sort)](#python-solution-flatten-sort)
      - [JavaScript Solution (Flatten & Sort)](#javascript-solution-flatten-sort)
    - [Note 1: Terminology and Techniques](#note-1-terminology-and-techniques)
    - [Note 2: Real-World Interview Variations](#note-2-real-world-interview-variations)
- [732. My Calendar III](#732-my-calendar-iii)
    - [1. Problem Explanation](#1-problem-explanation)
    - [2. Solution Explanation: The "Difference Array" / "Sweep Line"](#2-solution-explanation-the-difference-array-sweep-line)
      - [ASCII Visualization of the Sweep Line](#ascii-visualization-of-the-sweep-line)
    - [3. Time and Space Complexity Analysis](#3-time-and-space-complexity-analysis)
    - [4. Solution Code](#4-solution-code)
      - [Python Implementation (Using SortedDict)](#python-implementation-using-sorteddict)
      - [JavaScript Implementation](#javascript-implementation)
...
- [1353. Maximum Number of Events That Can Be Attended](#1353-maximum-number-of-events-that-can-be-attended)
    ...
    - [3. Time and Space Complexity Analysis](#3-time-and-space-complexity-analysis)
    - [4. Solution Code](#4-solution-code)
      - [Python Implementation (Using )](#python-implementation-using)
      - [JavaScript Implementation (Using a simple Min-Heap)](#javascript-implementation-using-a-simple-min-heap)
    - [Note 1: Terminology & Techniques](#note-1-terminology-techniques)
    - [Note 2: Real-World Interview Variations](#note-2-real-world-interview-variations)
